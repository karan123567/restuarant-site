...
const STEPS = ["Date & Guests", "Time", "Your Details", "Confirm"];
          ...
          <div key={label} style={{ display: "flex", alignItems: "center", flex: i < STEPS.length - 1 ? 1 : "none" }}>
            ...
            {i < STEPS.length - 1 && (
              <motion.div
                ...
                style={{ flex: 1, height: "1px", margin: "0 8px", marginBottom: "22px" }}
              />
            )}
          </div>
        );
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
      <label
        style={{
          ...
          textTransform: "uppercase",
          color: focused ? "#C9A96E" : "rgba(245,240,232,0.4)",
...
export default function ReservationForm() {
  ...
  function handleSubmit() {
    // Replace with your /api/reservations POST call
    setSubmitted(true);
  }
  ...
  return (
    <>
      <style>{`
        ...
        input[type="date"]::-webkit-calendar-picker-indicator { filter: invert(0.6) sepia(1) saturate(2) hue-rotate(5deg); cursor: pointer; }
      ...
      >
        {/* ── LEFT: info panel ── */}
        <div ref={leftRef} style={{ flex: "0 0 340px", maxWidth: "340px" }}>
          ...
          <AnimatePresence mode="wait">
            {submitted ? (
              ...
              >
                ...
                <h3 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "32px", fontWeight: 300, color: "#F5F0E8", margin: "0 0 12px" }}>
                  Table Reserved
                </h3>
                ...
                <div style={{ marginTop: "32px", padding: "20px", background: "rgba(201,169,110,0.06)", border: "1px solid rgba(201,169,110,0.15)", borderRadius: "2px" }}>
                  {[
                  ...
                  <AnimatePresence mode="wait" custom={direction}>
                    ...
                    {step === 1 && (
                      ...
                      >
                        <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "13px", color: "rgba(245,240,232,0.4)", marginBottom: "24px", lineHeight: 1.6 }}>
                          Select a time for {form.guests} {form.guests === 1 ? "guest" : "guests"} on{" "}
                    ...
                    {step === 3 && (
                      <motion.div
                        ...
                        exit="exit"
                      >
                        <div style={{ background: "rgba(201,169,110,0.05)", border: "1px solid rgba(201,169,110,0.12)", borderRadius: "2px", padding: "24px", marginBottom: "24px" }}>
                          {[
                            { label: "Date",   value: form.date },
                            { label: "Time",   value: form.time },
                            ...
                            <div key={label} style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "12px", marginBottom: "14px", paddingBottom: "14px", borderBottom: "1px solid rgba(201,169,110,0.08)" }}>
                              ...
                              <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "13px", fontWeight: 300, color: "#E8D5B0", textAlign: "right" }}>{value}</span>
                            </div>
                          ))}
                        </div>
                        <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "11px", color: "rgba(245,240,232,0.3)", lineHeight: 1.7, margin: 0 }}>
                          By confirming, you agree to our cancellation policy. A confirmation email will be sent to {form.email}.
                        </p>
                      </motion.div>
                    )}
                  </AnimatePresence>
